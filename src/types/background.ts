...
export interface BorderElement {
  ...
  animation: 'float' | 'rotate-cw' | 'rotate-ccw' | 'blink' | 'pop' | 'bounce' | 'shake' | 'pulse' | 'revolve' | 'travel' | 'spin' | 'spin-ccw';
  ...
  borderSide?: 'all' | 'top' | 'right' | 'bottom' | 'left'; // which border edge(s) to travel on
}
