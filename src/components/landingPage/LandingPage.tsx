...
return (
  ...
  {/* Sticky Header */}
  <header className="sticky z-50 shadow-lg bg-background/80 backdrop-blur-xl border-b border-border/50">
...
<div className="fixed inset-0 overflow-hidden pointer-events-none -z-10">
  ...
  <Button
    ...
    size="lg"
    className="px-4 sm:px-8 lg:px-12 py-4 sm:py-6 lg:py-7 mb-6 sm:mb-10 lg:mb-12 relative overflow-hidden group animate-in zoom-in-95 shadow-xl hover:shadow-2xl hover:shadow-primary/30 transition-all duration-500 bg-gradient-to-r from-pink-500 via-purple-500 to-violet-600 hover:from-pink-600 hover:via-purple-600 hover:to-violet-700 text-white font-semibold"
  >
    {/* Main Content */}
    <span className="relative z-10 flex items-center justify-center gap-2 sm:gap-3">
      <span className="text-lg sm:text-xl lg:text-2xl group-hover:rotate-180 transition-transform duration-500">
        🚀
      </span>
    ...
    {/* Shine Effect */}
    <span 
      className="absolute top-0 left-1/2 w-20 h-full bg-white/30 -skew-x-12 transform -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-opacity duration-700 group-hover:animate-shine"
    />
    
    {/* Subtle Border Glow */}
    <span 
      className="absolute inset-0 rounded-lg border-2 border-transparent group-hover:border-white/20 transition-all duration-300"
    />
    
    {/* Animated Gradient Border */}
    <span 
      className="absolute inset-0 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-500 bg-gradient-to-r from-pink-400/50 via-purple-400/50 to-violet-400/50 blur-sm group-hover:animate-pulse"
    />
  </Button>
</div>
