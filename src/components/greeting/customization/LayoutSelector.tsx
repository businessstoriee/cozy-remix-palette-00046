  ...
  return (
      ...
      <div className="">
        ...
        <motion.div 
          initial={false}
          animate={{ height: 'auto' }}
          className="rounded-lg border border-purple-500 shadow-lg hover:shadow-xl bg-gradient-to-br from-white to-gray-50/50 dark:from-slate-900 dark:to-slate-800 dark:border-slate-700 dark:shadow-slate-900/50 overflow-hidden"
        >
          <button
