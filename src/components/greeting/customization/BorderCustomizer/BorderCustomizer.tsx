...
import { Frame, Plus, Trash2, Square, ChevronDown, ChevronUp } from 'lucide-react';
...
const BorderCustomizer: React.FC<BorderCustomizerProps> = ({ settings, onChange }) => {
  ...
  // ✅ Auto expand if turning ON the switch
  ...
  <div className="flex items-center justify-between">
    <CardTitle className="text-sm flex items-center gap-2">
      <div className="p-2 bg-gradient-to-br from-purple-200 to-secondary/20 dark:bg-purple-900/50 rounded-lg">
                <Frame className="h-4 w-4 text-purple-600 dark:text-purple-400" />
              </div>
                  ...
                  <div>
                    ...
                    {el.animation === 'travel' && (
                      <>
                        ...
                        <div>
                          <Label className="text-xs">Border Side</Label>
                          <Select 
                            value={el.borderSide || 'all'} 
                            onValueChange={(v) => updateElement(el.id, 'borderSide', v)}
                          >
                            <SelectTrigger>
                              <SelectValue />
                            </SelectTrigger>
