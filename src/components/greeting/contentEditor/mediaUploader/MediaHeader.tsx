    ...
    <div className="px-2 py-6 space-y-4">
      <div className="flex flex-col xs:flex-row xs:items-center justify-between gap-2 xs:gap-4">
        ...
        <div className="flex items-center gap-1 min-w-0">
          <div className="relative shrink-0 p-2 bg-gradient-to-br from-purple-200 to-secondary/20 dark:bg-purple-900/50 rounded-lg">
            <Image className="h-4 w-4  text-purple-500" />
            <Video className="h-4 w-4 absolute bottom-1 -right-1 bg-background text-violet-500 rounded-full p-0.5" />
          </div> 
