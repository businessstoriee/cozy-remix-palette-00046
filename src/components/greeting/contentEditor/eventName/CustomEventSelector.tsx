  ...
  return (
        ...
        <CardTitle className="text-sm flex items-center justify-between">
          <div className="flex items-center gap-2">
           ...
           <Button 
                    ...
                    className="relative overflow-hidden bg-gradient-to-r from-purple-800 to-purple-500 hover:from-purple-600 hover:to-purple-700 text-white hover:shadow-lg rounded-md group"
                  >
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          <Label htmlFor="eventType">Select Event Type <span className='text-purple-500'>*</span></Label>
            ...
            <>
              ...
              <div>
                <p className="font-semibold text-foreground dark:text-purple-200" style={{
                  ...
                  {eventNameStyle?.content || selectedEventData?.label || 'Event'}
                </p>
