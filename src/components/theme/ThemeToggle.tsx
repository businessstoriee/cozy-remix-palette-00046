...
const ThemeToggle: React.FC = () => {
  ...
  <Tooltip>
    ...
    >
      <div
  className={cn(
    "flex items-center gap-2 sm:gap-3 px-2 py-1 sm:px-4 sm:py-2 rounded-full backdrop-blur-lg border-2 transition-all duration-&lsqb;1250ms&rsqb; ease-&lsqb;cubic-bezier(0.19,1,0.22,1)&rsqb; shadow-lg outline outline-1 outline-white/50 outline-offset-0 hover:border-white hover:shadow-[inset_0_0_20px_rgba(255,255,255,0.5),0_0_20px_rgba(255,255,255,0.2)] hover:outline-transparent hover:outline-offset-8 hover:[text-shadow:1px_1px_2px_#427388]",
    isDark
