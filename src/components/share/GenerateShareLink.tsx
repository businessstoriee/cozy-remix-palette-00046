...
const FirebaseShareButton: React.FC<FirebaseShareButtonProps> = ({
  ...
  return (
    <motion.div
      ...
      className="fixed bottom-0 left-0 right-0 z-40 bg-gradient-to-t from-background via-background to-background/95 backdrop-blur-xl border-t border-border/50" // z-40 (lower than sidebar)
    >
