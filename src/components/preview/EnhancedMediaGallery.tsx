        ...
        >
          ...
          >
            ...
            >
              ...
              <img
                src={src}
                alt={`${greetingData.eventType || greetingData.customEventName || 'greeting'} greeting card - ${greetingData.texts?.[0]?.content?.substring(0, 80) || `${greetingData.senderName || 'Someone'} wishes ${greetingData.receiverName || 'you'}`} - free online greeting card maker`}
                loading="lazy"
          ...
          >
            ...
            >
              ...
              <video
                ...
                muted={muted}
                preload="metadata"
                aria-label={`${greetingData.eventType || greetingData.customEventName || 'greeting'} greeting card video - ${greetingData.texts?.[0]?.content?.substring(0, 80) || `${greetingData.senderName || 'Someone'} wishes ${greetingData.receiverName || 'you'}`} - online greeting card with video`}
