...
import { X, HelpCircle, Home, Sparkles, BookOpen } from 'lucide-react';
...
const navItems = [
  ...
  { title: 'Templates', path: '/templates', icon: Sparkles },
  { title: 'Blog', path: '/blog', icon: BookOpen },
  { title: 'Help & Information', path: '/help', icon: HelpCircle },
];

const AnimatedSidebar: React.FC<AnimatedSidebarProps> = ({ isOpen, onClose }) => {
  const location = useLocation();
  const [hoveredIndex, setHoveredIndex] = useState<number | null>(null);
  const [importantPagesOpen, setImportantPagesOpen] = useState(false);
